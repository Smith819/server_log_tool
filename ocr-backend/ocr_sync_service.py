...
class SyncConfig:
    ...
    api_tls_cert_file: Path | None
    api_tls_key_file: Path | None
    api_tls_min_tls_version: str
...
def load_config(config_file: Path = CONFIG_FILE) -> SyncConfig:
    ...
    api_tls_enabled, api_tls_cert_file, api_tls_key_file, api_tls_min_tls_version = load_tls_settings(cfg, "api_tls")
    ...
    return SyncConfig(
        ...
        api_tls_key_file=api_tls_key_file,
        api_tls_min_tls_version=api_tls_min_tls_version,
...
class FrontendClient:
    ...
    def _open(self, url: str):
        ...
        context = build_client_ssl_context(
            ...
            tls_enabled=self.config.client_tls_enabled,
            cert_file=self.config.client_tls_cert_file,
            key_file=self.config.client_tls_key_file,
            min_tls_version=self.config.client_tls_min_tls_version,
        )
